...
4. `bright_arc_all_conditions.json` — Combined bright-arc detection rates for all 6 experimental conditions (baseline, Poisson, clip20, Poisson+clip20, unrestricted, gain=1e12), plus linear probe and Tier-A scoring results
