# MNRAS Injection Pipeline Validation Report

**Date:** 2026-02-13
**Model:** EfficientNetV2-S v4 (fine-tuned), Epoch 1
...
### Physics engine
- `dhs/injection_engine.py` — SIE+shear ray-tracing, Sersic source, FFT PSF, flux calibration

### Tests
- `tests/test_injection_engine.py` — 28 unit/physics tests (8 classes)

### Selection function pipeline
- `scripts/selection_function_grid.py` — Main injection-recovery grid
- `scripts/sensitivity_analysis.py` — 8-perturbation systematic uncertainty
- `scripts/validate_injections.py` — Runtime QA with visual output

### Sim-to-real validation suite
- `sim_to_real_validations/real_lens_scoring.py` — Score real confirmed lenses
- `sim_to_real_validations/confuser_morphology_test.py` — Morphology shortcut test
- `sim_to_real_validations/bright_arc_injection_test.py` — Brightness-dependent completeness
- `sim_to_real_validations/sim_to_real_validation.py` — Comprehensive diagnostic
