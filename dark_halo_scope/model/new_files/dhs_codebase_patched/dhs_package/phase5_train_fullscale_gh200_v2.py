...
class ParquetStreamDataset(IterableDataset):
    ...
    def _iter_fragments(self) -> List[ds.Fragment]:
        ...
        # IMPORTANT: shard by both distributed rank and DataLoader worker id to avoid
...
def main():
    ...
    forbidden_meta = {
        # injection parameters and injection-derived metrics (label leakage)
        "theta_e_arcsec", "theta_e", "src_dmag", "src_reff_arcsec", "src_e", "shear", "shear_phi_rad",
        "lens_e", "lens_phi_rad", "src_x_arcsec", "src_y_arcsec", "magnification", "tangential_stretch",
